...
//putting in five variables that will be passed through to this code where these five variables will be set from your old username account
...
$qquery = $_SESSION["connection"]->query("UPDATE users SET "
        . "exp = $exp, "   
        . "exp1 = $exp1, "
        . "exp2 = $exp2, "
        . "exp3 = $exp3, "
...
if($query){ //if worked then true is echoed out
    echo "true";
}else{// if it didn't work then error is echoed out
